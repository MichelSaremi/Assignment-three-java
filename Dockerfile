...
ENV DATABASE_URL ""
ENV ISSUER_URL "http://localhost:8083/auth/realms/assignment-three"
ENV JWKS_URI "http://localhost:8083/auth/realms/assignment-three/protocol/openid-connect/certs"
